...
class PromotionsViewHolderForCorousel(binding: MainPromotionsItemBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    fun bind(
        ...
        clickListener: PromotionsRecyclerAdapterForCorousel.OnItemClickListener
    ) {
